...
public class Task8Parser extends Parser {
	...
	public static class TempContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Task8Listener ) ((Task8Listener)listener).enterTemp(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Task8Listener ) ((Task8Listener)listener).exitTemp(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Task8Visitor ) return ((Task8Visitor<? extends T>)visitor).visitTemp(this);
	...
	public final TempContext temp() throws RecognitionException {
		...
		enterRule(_localctx, 0, RULE_temp);
		try {
